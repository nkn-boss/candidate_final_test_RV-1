...
export default class fetchProjectDetails extends LightningElement {
    ...
    navigateToPage(event) {
        ...
        console.log('page ref',JSON.stringify(this.pageReference));
        ...
        this[NavigationMixin.Navigate]({
            ...
            attributes: {
                url: `https://epam-2e1-dev-ed.develop.my.site.com/asset/s/${page}`
                //  url: `/s/${this.pageReference.attributes.url}/${page}`
            }
        });
    }
